...
double L_angle_ini = 90;          /* Long arm's initial angle */
double S_angle_ini = 60;           /* Short arm's initial angle */

//Velocity for manual control
double X_velocity_MAX = 0.3;         /* Velocity of gripper along X-direction */
double Y_velocity_MAX = 0.3;        /* Velocity of gripper along Y-direction */
double Rotate_velocity = 0.8;    /* Velocity of arm rotation */


//Velocity for auto control
double auto_Velocity_scale = 15;
double auto_X_MAX_velocity = 0.2;          /* Auto velocity of gripper along X-direction */
double auto_Y_MAX_velocity = 0.2;         /* Auto velocity of gripper along Y-direction */
double auto_Rotate_MAX_velocity = 1 ;     /* Auto velocity of arm rotation */
...
//Initial position
double Gripper_angle_ini = 4
                           ;    /* open */
double Head_angle_ini = 30;
double Head_angle_MAX = 176;
double Head_angle_MIN = 4;
double Gripper_angle_MAX = 160;   /* close */

//Velocity
double Grap_velocity = 1;
double Release_velocity = 3;
double Head_velocity = 1;
...
void loop() {
  ...
  if (Serial2.available()) {
    ...
    if (BT_signal == EMPTY_1) {
      ...
      if (!Place_1) {
        To_Point(11.92, 8.16, 20);
        To_Point(14.64, 10.51, 78.50);
        To_Point(9.29, 8.00, 80.00);
        Place_1 = true;
      }
      else {
        To_Point(11.92, 8.16, 20);
      ...
      if (!Place_2) {
        To_Point(11.92, 8.16, 20);
        To_Point(13.39, 10.35, 93.50);
        To_Point(9.36, 7.69, 100.70);
        Place_2 = true;
      }
      else {
        To_Point(11.92, 8.16, 20);
      ...
      if (!Place_3) {
        To_Point(11.92, 8.16, 20);
        To_Point(13.39, 10.35, 120.80);
        To_Point(9.46, 6.98, 130.70);
        Place_3 = true;
      }
      else {
        To_Point(11.92, 8.16, 20);
      ...
      if (!Place_4) {
        To_Point(11.92, 8.16, 20);
        To_Point(15.96, 10.73, 138.20);
        To_Point(12.86, 7.73, 153.10);
        Place_4 = true;
      }
      else {
        To_Point(11.92, 8.16, 20);
