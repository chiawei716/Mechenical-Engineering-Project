...
void loop() {
  ...
  /*
  if(ps2x.Analog(PSS_LY) > 130 || ps2x.Analog(PSS_LY) < 125 || ps2x.Analog(PSS_LX) > 130 || ps2x.Analog(PSS_LX) < 125){
  ...
  else if (ps2x.Analog(PSS_LY) <= 120 && ps2x.Analog(PSS_LX) > 120 && ps2x.Analog(PSS_LX) < 130) {
    move_forward();
  }
  ...
  else if (ps2x.Analog(PSS_LX) >= 135 && ps2x.Analog(PSS_LY) > 120 && ps2x.Analog(PSS_LY) < 135)
  {
    move_rightward();
  }

  /*diagonal*/
  else if (ps2x.Analog(PSS_LX) >= 135 && ps2x.Analog(PSS_LY) <= 120)
  {
    move_right_forward();
  }
